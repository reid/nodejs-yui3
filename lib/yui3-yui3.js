...
exports.configure = function(c) {
    ...
    try {
        ...
        if (!coreHash[core].SCRIPT) {
            coreHash[core].SCRIPT = useVM.createScript(fileStr, coreHash[core].FILEPATH);
        }
                    ...
                    */
                    ...
                    if (useVM) {
                        ...
                        if (!execCache[file].script) {
                            execCache[file].script = useVM.createScript(mod, execCache[file].filepath);
                        }
